...
export function useEventStaffing(hotelId?: string) {
  ...
  const fetchStaffing = useCallback(
    async (filters: StaffingFilters = {}) => {
      try {
        ...
        const endpoint = `/events/staffing?${queryParams.toString()}`
  ...
  const getStaffingById = async (id: string) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/${id}`, "GET")
  ...
  const createStaffing = async (staffingData: Partial<EventStaffing>) => {
    try {
      setLoading(true)
      const response = await request("/events/staffing", "POST", staffingData)
  ...
  const updateStaffing = async (id: string, staffingData: Partial<EventStaffing>) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/${id}`, "PUT", staffingData)
  ...
  const deleteStaffing = async (id: string) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/${id}`, "DELETE")
  ...
  const assignStaffToEvent = async (
    ...
    try {
      setLoading(true)
      const response = await request(`/events/staffing/event/${eventId}/assign`, "POST", assignmentData)
  ...
  const unassignStaffFromEvent = async (eventId: string, staffId: string) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/event/${eventId}/unassign/${staffId}`, "DELETE")
  ...
  const checkInStaff = async (staffingId: string, notes?: string) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/${staffingId}/checkin`, "POST", { notes })
  ...
  const checkOutStaff = async (staffingId: string, notes?: string) => {
    try {
      setLoading(true)
      const response = await request(`/events/staffing/${staffingId}/checkout`, "POST", { notes })
  ...
  const getStaffTimesheet = async (staffingId: string) => {
    try {
      const response = await request(`/events/staffing/${staffingId}/timesheet`, "GET")
  ...
  const getPerformanceHistory = async (staffingId: string) => {
    try {
      const response = await request(`/events/staffing/${staffingId}/performance`, "GET")
  ...
  const getStaffingConflicts = async (
    ...
    try {
      ...
      const response = await request(`/events/staffing/conflicts?${queryParams.toString()}`, "GET")
  ...
  const resolveConflict = async (
    ...
    try {
      setLoading(true)
      const response = await request(`/events/staffing/conflicts/${conflictId}/resolve`, "POST", resolution)
