...
import { HousekeepingSidebar } from "@/components/housekeeping/housekeeping-sidebar"
...
export default function HousekeepingLayout({
  ...
  useEffect(() => {
    const verifyAuth = async () => {
      console.log("Housekeeping layout mounted, checking auth")
