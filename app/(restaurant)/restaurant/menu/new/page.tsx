                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <CurrencyInput
                        ...
                        onChange={(usdValue) => form.setValue("price", usdValue)}
                        required
                      />
                    ...
                    <div className="space-y-2">
                      <CurrencyInput
                        ...
                        onChange={(usdValue) => form.setValue("cost", usdValue)}
                        required
                      />
                      {form.formState.errors.cost && (
                        <p className="text-sm font-medium text-destructive">{form.formState.errors.cost.message}</p>
                      )}
                    </div>
                  </div>
