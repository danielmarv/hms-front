...
export function ReportDetailsDialog({ report, open, onOpenChange, handleDownload }: ReportDetailsDialogProps) {
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{report.name || "N/A"}</p>
                    </div>
                    <div>
